...
// demo1_email = import.meta.env.VITE_DEMO1_EMAIL || "demo1@meetspace.com";
// demo1_password = import.meta.env.VITE_DEMO1_PASSWORD || "demo@123";
// demo2_email = import.meta.env.VITE_DEMO2_EMAIL || "demo2@meetspace.com";
// demo2_password = import.meta.env.VITE_DEMO2_PASSWORD || "demo@123";
...
export default function LoginPage() {
  ...
  const handleDemoLogin= async(demo_email , demo_pass)=>{
    try{
      const result = await login(demo_email, demo_pass);
      if(result.success){
        navigate("/home");
        toast.success("Login successful");
      }
    ...
    <div className="min-h-screen w-full flex font-sans">
      ...
      <div className="flex-1 flex items-center justify-center p-8" style={{ background: "#FAFAFA" }}>
        <div className="w-full max-w-sm">
          ...
          <h2 className="text-2xl font-medium text-slate-900 mb-1">Sign in</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <button
              ...
              onClick={() => handleDemoLogin("demo1@meetspace.com", "demo@123")}
            >
              Demo Account 1
            </button>
            <button
               className="cursor-pointer bg-background hover:bg-background-muted shadow-sm border border-border-muted hover:border-border/60 rounded-md p-2 flex justify-center items-center gap-4 text-sm sm:text-md w-full mt-4"
              onClick={() => handleDemoLogin("demo2@meetspace.com", "demo@123")}
            >
              Demo Account 2
            </button>
          </div>
